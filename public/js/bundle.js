...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    //mesmo id do elemento em tour que ira mostrar o mapa
...
var stripe = Stripe('pk_test_51M14TyGHL44D8tR4PW9EZajUqGreiYctTbmU7CesM0l79xOEt7laTjrTasJ3jBmoRCbePeYiHN8t5b97AYIqDbkq00Gr8OUMUJ');
...
var logOutBtn = document.querySelector('.nav__el--logout'); //botao do logout 
var bookBtn = document.getElementById('book-tour'); //botao em tour.pug para o checkout
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //id da tour
